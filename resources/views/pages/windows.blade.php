				...
				<nav class="card">
					<header class="card-header">
						<p class="card-header-title">
							Windows miner setup (for Windows 10 64-bit)
						</p>
					</header>
					...
					<div class="card-content">
						<div class="content">
							...
							<ol>
								...
								<li>Type <code>xdag -d -m 1 xdagpool.com:16543</code> and press enter.</li>
								...
								<li>Edit with notepad. If your system clock is already set to GMT, insert one line into the file: <pre class="oneline">C:\xdag\xdag.exe -d -m <span class="parameter">4</span> xdagpool.com:13654</pre> Replace <span class="parameter">4</span> with number of mining threads, for dedicated mining machines, set this to number of CPU threads. If your system clock is not set to GMT, see the next section.</li>
						...
						<div class="content">
							<ol>
								...
								<li>In step 8. above, paste the following line into the <code>RUNMINER.bat</code> file:
									<pre class="oneline">
										runasdate /movetime /startin "C:\xdag" Hours:<span class="parameter">-1</span> "C:\xdag\xdag.exe" -d -m <span class="parameter">4</span> xdagpool.com:13654
									</pre>
