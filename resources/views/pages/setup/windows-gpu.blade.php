				...
				<div class="card-content">
					<div class="content">
						<ol>
							...
							<li>Edit with notepad. Insert one line into the file: <pre class="oneline">C:\DaggerGpuMiner\win64exe\xdag.exe -d -m 1 {{ Setting::get('pool_domain') }}:{{ Setting::get('pool_port') }}</pre>
