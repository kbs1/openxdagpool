				...
				<div class="card-content">
					<div class="content">
						<ol>
							...
							<li>Change directory: <code> cd ./xdag/cient</code></li>
...
(cd ./xdag/cient &amp;&amp; ./xdag -d -m <span class="parameter">4</span> {{ Setting::get('pool_domain') }}:{{ Setting::get('pool_port') }})
echo -n "Daemon PIDs: "
pidof xdag
...
(cd ./xdag &amp;&amp; git pull &amp;&amp; cd ./cient &amp;&amp; make)
