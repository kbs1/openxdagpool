				...
				<nav class="card">
					<header class="card-header">
						<p class="card-header-title">
							Unix miner setup (for Ubuntu 16.04)
						</p>
					</header>
					...
					<div class="card-content">
						<div class="content">
							...
							<ol>
								...
								<li>Run the program with <code>TZ=GMT ./xdag -d -m 1 xdagpool.com:16543</code>. Set up your wallet password, type random keys.</li>
...
(cd ./cheatcoin/cheatcoin &amp;&amp; TZ=GMT ./xdag -d -m <span class="parameter">4</span> xdagpool.com:13654)
echo -n "Daemon PIDs: "
pidof xdag
