	...
	<div class="miners-view">
		<div class="columns is-marginless is-centered">
			<div class="column is-7">
				...
				<hr>
				<p><span class="important">Note:</span> hash rate calculation is purely informational, it does <strong>not</strong> represent 'what the pool sees', or your real mining speed. It is a statistical approximation, displayed for informational purposes only. The reading should start matching your real speed over a longer period of time (usually 6 hours).</p><p>You are always mining at full speed reported by typing <code>stats</code> into your miner console.</p>
				<hr>
