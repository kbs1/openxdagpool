...
class Miner extends Model
{
	...
	{
		return $this->stats()->selectRaw('miner_stats.*, DATE_FORMAT(miner_stats.created_at, "%Y-%m-%d %H:00") date')->where('created_at', '>=', Carbon::now()->subDays(3))->groupBy('date')->orderBy('id')->get();
	}
}
